...
urlpatterns = [
    ...
    path('api/notificaciones/eliminar-todas/', views.eliminar_todas_notificaciones, name='eliminar_todas_notificaciones'),
    path('api/notificaciones/<int:notificacion_id>/leer/', views.marcar_notificacion_leida, name='marcar_notificacion_leida'),
    path('api/notificaciones/<int:notificacion_id>/eliminar/', views.eliminar_notificacion, name='eliminar_notificacion'),
    ...
    path('api/configuracion/respaldos/eliminar/', views.eliminar_respaldo_db, name='eliminar_respaldo_db'),
    path('api/configuracion/base-de-datos/optimizar/', views.optimizar_base_datos, name='optimizar_base_datos'),
    ...
    path('api/parcelas/', views.crear_parcela, name='crear_parcela'),
    path('api/parcelas/<int:parcela_id>/eliminar/', views.eliminar_parcela, name='eliminar_parcela'),
