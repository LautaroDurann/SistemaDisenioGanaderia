...
### 7.4 Documentación técnica y de negocio
Mantener documentados:
- casos de uso
- DER
- modelo relacional
- flujo de procesos del campo
- reglas de negocio del sistema

## 8. Siguiente paso recomendado
El siguiente paso más valioso es consolidar la capa de seguridad y roles, para que el sistema no solo registre información, sino que también respete permisos reales de negocio.

Después de eso, conviene trabajar en:
1. autenticación de usuarios y roles
2. formularios de alta/modificación con validaciones
3. reportes y exportación
4. documentación final para la materia
